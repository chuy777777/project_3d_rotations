...
class Graphic3D():
    ...
    def plot_coordinate_system(self, t_list, T_list, length=1, show_axis_text=True):
        H=None
        ...
        if show_axis_text:
            self.plot_texts(ps=vm[1:,:], text_list=["X","Y","Z"], color_rgb_list=[(255,0,0),(0,255,0),(0,0,255)], fontsize="large", fontfamily="sans-serif", fontweight="bold", horizontalalignment="center", verticalalignment="bottom")
        return H
